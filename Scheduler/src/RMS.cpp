...
int main(void)
{
    ...
    lio_omp_0.set_policy(SCHED_FIFO, 40);
    ...
    lio_omp_1.set_policy(SCHED_FIFO, 40);
    ...
    lio_omp_2.set_policy(SCHED_FIFO, 40);
    ...
    lio_ikd.set_policy(SCHED_FIFO, 90);
    ...
    ego_waypoint.set_policy(SCHED_FIFO, 40);
    ...
    ego_odometry.set_policy(SCHED_FIFO, 40);
    ...
    ego_execFSM.set_policy(SCHED_FIFO, 70);
    ...
    ego_checkColl.set_policy(SCHED_FIFO, 40);
    ...
    ego_vis.set_policy(SCHED_FIFO, 30);
    ...
    ego_updateOcc.set_policy(SCHED_FIFO, 40);
    ...
    ego_depthOdom.set_policy(SCHED_FIFO, 40);
    ...
    traj_main.set_policy(SCHED_FIFO, 70);
    ...
    offboard_main.set_policy(SCHED_FIFO, 60);
    ...
    vehicle_imu.set_policy(SCHED_FIFO, 99);
    ...
    vehicle_rate.set_policy(SCHED_FIFO, 99);
    ...
    vehicle_acc.set_policy(SCHED_FIFO, 99);
    ...
    vehicle_mag.set_policy(SCHED_FIFO, 50);
    ...
    vehicle_air.set_policy(SCHED_FIFO, 50);
    ...
    sensors.set_policy(SCHED_FIFO, 99);
    ...
    mc_hover_est.set_policy(SCHED_FIFO, 80);
    ...
    land_det.set_policy(SCHED_FIFO, 80);
    ...
    mc_rate_ctl.set_policy(SCHED_FIFO, 99);
    ...
    mc_att_ctl.set_policy(SCHED_FIFO, 99);
    ...
    mc_pos_ctl.set_policy(SCHED_FIFO, 80);
    ...
    flt_mod_man.set_policy(SCHED_FIFO, 60);
    ...
    ctl_alloc.set_policy(SCHED_FIFO, 99);
    ...
    pwm_out_sim.set_policy(SCHED_FIFO, 99);
