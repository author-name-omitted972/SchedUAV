...
int main(void)
{
    ...
    lio_omp_1.set_policy(SCHED_FIFO, 39);
    ...
    lio_omp_2.set_policy(SCHED_FIFO, 39);
    ...
    ego_odometry.set_policy(SCHED_FIFO, 38);
    ...
    ego_checkColl.set_policy(SCHED_FIFO, 36);
    ...
    ego_updateOcc.set_policy(SCHED_FIFO, 37);
    ...
    ego_depthOdom.set_policy(SCHED_FIFO, 38);
    ...
    traj_main.set_policy(SCHED_FIFO, 69);
    ...
    sensors.set_policy(SCHED_FIFO, 98);
    ...
    mc_rate_ctl.set_policy(SCHED_FIFO, 95);
    ...
    mc_att_ctl.set_policy(SCHED_FIFO, 96);
    ...
    mc_pos_ctl.set_policy(SCHED_FIFO, 79);
    ...
    ctl_alloc.set_policy(SCHED_FIFO, 94);
    ...
    pwm_out_sim.set_policy(SCHED_FIFO, 93);
